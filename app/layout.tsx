...
metadataBase: new URL(process.env.NEXT_PUBLIC_SITE_URL || "https://www.musadvocates.co.ke"),
alternates: {
    canonical: `${process.env.NEXT_PUBLIC_SITE_URL || "https://www.musadvocates.co.ke"}`,
  },
  openGraph: {
    ...
    url: `${process.env.NEXT_PUBLIC_SITE_URL || "https://www.musadvocates.co.ke"}`,
