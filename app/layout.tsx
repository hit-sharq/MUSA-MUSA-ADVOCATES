...
metadataBase: new URL(process.env.NEXT_PUBLIC_SITE_URL || "https://musadvocates.co.ke"),
alternates: {
    canonical: `${process.env.NEXT_PUBLIC_SITE_URL || "https://musadvocates.co.ke"}`,
  },
  openGraph: {
    ...
    url: `${process.env.NEXT_PUBLIC_SITE_URL || "https://musadvocates.co.ke"}`,
...
export default function RootLayout({
  ...
  const jsonLd = {
    ...
    url: `${process.env.NEXT_PUBLIC_SITE_URL || "https://musadvocates.co.ke"}`,
    logo: `${process.env.NEXT_PUBLIC_SITE_URL || "https://musadvocates.co.ke"}/logo.png`,
    image: `${process.env.NEXT_PUBLIC_SITE_URL || "https://musadvocates.co.ke"}/og-image.jpg`,
