...
export const metadata: Metadata = {
  title: "Privacy Policy | Musa & Musa Advocates",
  description: "Privacy Policy for Musa & Musa Advocates - How we collect, use, and protect your personal information.",
}
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">
                Musa & Musa Advocates ("we," "our," or "us") is committed to protecting your privacy. This Privacy
